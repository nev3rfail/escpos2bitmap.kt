...
class EscPosConverter {
    companion object {
        ...
        fun escpos2bitmap(escpos: ByteArray, escPosConfig: EscPosConfig): Bitmap {
            return escpos2bitmap(escpos, escPosConfig, EscPosState(currImg = Bitmap.createBitmap(escPosConfig.imgWidth, escPosConfig.fontScale.y, Bitmap.Config.RGB_565).apply {
        ...
        fun escpos2bitmap(escpos: ByteArray,  escPosConfig: EscPosConfig, escPosState: EscPosState): Bitmap {
            ...
            val finalImage = Bitmap.createBitmap(escPosConfig.imgWidth, imgHeight, Bitmap.Config.RGB_565)
...
fun onAscii(buff: ByteArray, state: EscPosState, idx: IntArray, cfg: EscPosConfig) {
    ...
    when (byte) {
        ...
        0x0A.toByte() -> {
            val img = Bitmap.createBitmap(cfg.imgWidth, cfg.fontScale.y,Bitmap.Config.RGB_565) // Assuming createNewImage creates a new image
            //img.fill(255.toByte())
